...
var getMonthName = function (a) {
    ...
    Morris.Donut({
        ...
        data: [{label: "Essais ", value: 900}, {label: "Utilisateurs valides", value: 1200}],
        colors: [a, b],
...
// },
 DashboardV2 = function () {
    ...
    return {
        init: function () {
            handleVisitorsLineChart(), handleVisitorsDonutChart(), handleVisitorsVectorMap(), handleScheduleCalendar()
        }
    }
}();